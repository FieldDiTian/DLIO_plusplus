#ifndef GICP_LOCALIZATION_LUMINAR_SWEEP_MATCHING_HPP
#define GICP_LOCALIZATION_LUMINAR_SWEEP_MATCHING_HPP
...
// Endpoint matching requires |aux.min - primary.min| <= threshold. Once an
// in-order aux stream has advanced past primary.min + threshold, no later sweep
// can match this primary. This is a watermark, not a clock-offset estimate.
...
#endif  // GICP_LOCALIZATION_LUMINAR_SWEEP_MATCHING_HPP
